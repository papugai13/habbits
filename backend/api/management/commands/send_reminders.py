...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for setting in active_settings:
            ...
            # We use a 5-minute window for robustness if the cron runs every 5 mins
            # Or exactly if it runs every minute.
    ...
    def send_to_user(self, reminder_setting):
        ...
        for sub in subscriptions:
            try:
                ...
                # If subscription is expired, we might want to delete it
